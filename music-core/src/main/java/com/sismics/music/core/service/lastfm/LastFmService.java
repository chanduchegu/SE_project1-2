 ...
 * @author jtremeaux
 */
public class LastFmService extends AbstractScheduledService implements RecommendAPI {
    /**
     * Logger.
     */
    ...
    public String playListRecommend(String song,String artist) {
        ...
        // String endpointUrl =
        // "http://ws.audioscrobbler.com/2.0/?method=tag.getsimilar&tag=" + query +
        // "&api_key=" + key+ "&format=json";
        String endpointUrl = "http://ws.audioscrobbler.com/2.0/?method=track.getsimilar&artist="+artist+"&track="+song+"&api_key="
                + key
                + "&format=json";
        try {
            URL url = new URL(endpointUrl);
